...
Example: ◼️ `https://script.google.com/macros/s/...gwlprM_Kn10kT7LGk/exec`

- To use the script, you need to add the `region` and `service` parameters at the end of the URL.

Example: ◼️  `https://script.google.com/macros/s/...gwlprM_Kn10kT7LGk/exec?region=all&service=Plex`
